...
<div id="searchlist">
        <!-- Projects Row -->
       <h3>PUSHPAK model aircraft parts</h3>
<br><br>
...
<form action="addcart.php" method="post">
    ...
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 350);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Body'>
            <input type= 'hidden' name='pprice' value='350'>
            <br><br>
...
<form action="addcart.php" method="post">
    ...
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 200);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Wings'>
            <input type= 'hidden' name='pprice' value='200'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Ailerons'>
            <input type= 'hidden' name='pprice' value='200'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Flaps'>
...
<div  style="width:200px;height:150px;border:1px solid #000;">     
<form action="addcart.php" method="post">
    <h5>&nbsp;&nbsp;PUSHPAK Vertical Stabilizer</h5>
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 100);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Verticalstabilizer'>
            <input type= 'hidden' name='pprice' value='100'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
...
<div  style="width:200px;height:150px;border:1px solid #000;">     
<form action="addcart.php" method="post">
    <h5>&nbsp;&nbsp;PUSHPAK Horizontal Stabilizer</h5>
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 150);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Pushpak-Horizontalstabilizer'>
            <input type= 'hidden' name='pprice' value='150'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
