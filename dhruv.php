...
<div id="searchlist">
        <!-- Projects Row -->
       <h3>DHRUV model aircraft parts</h3>
<br><br>
...
<form action="addcart.php" method="post">
    ...
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 400);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Body'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Mainrotor'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Tailrotor'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Rotormast'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Cockpit'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_Dhruv-Skids'>
            <input type= 'hidden' name='pprice' value='100'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
