...
<div id="searchlist">
        <!-- Projects Row -->
       <h3>MIG21 model aircraft parts</h3>
<br><br>
...
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Body'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Wings'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Ailerons'>
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Flaps'>
            <input type= 'hidden' name='pprice' value='50'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
...
<div  style="width:200px;height:150px;border:1px solid #000;">     
<form action="addcart.php" method="post">
    <h5>&nbsp;&nbsp;MIG 21 Vertical Stabilizer</h5>
    <?php
     setlocale(LC_MONETARY, 'en_IN');
...
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Verticalstabilizer'>
...
<div  style="width:200px;height:150px;border:1px solid #000;">     
<form action="addcart.php" method="post">
    <h5>&nbsp;&nbsp;MIG 21 Horizontal Stabilizer</h5>
    <?php
     setlocale(LC_MONETARY, 'en_IN');
            $prodPrice= money_format('%!i', 150);
            echo "&nbsp;&nbsp;Price = &#8377;".$prodPrice;
?>    
      <br>  
&nbsp;&nbsp;<input type='number' name='quant' style='width:50px;' min='1' value='1'>
            <input type= 'hidden' name='id' value='aircraft_MIG21-Horizontalstabilizer'>
            <input type= 'hidden' name='pprice' value='150'>
            <br><br>
 &nbsp; <input type='submit' value='Add to cart' class='btn btn-default' style= 'background-color : #33ACFF; color : #fff;'>
